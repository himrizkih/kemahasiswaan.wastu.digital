...
<body class="bg-dark">
  ...
  { 
    if($_GET['pesan'] == "salah")
      ...
      { 
        echo "<div class='alert alert-info'>Berkas Persyaratan. Hanya dapat dilampirkan dalam 1 (satu) file PDF.</div>";
      } else { 
...
?>
        ...
        <form action="<?php echo base_url() ?>admin/kemahasiswaan/masuk_bea_mhs_daftar/proses" method="post">
          <div class="logo">
