...
<body class="bg-dark">
  ...
  { 
    if($_GET['pesan'] == "salah")
      { 
        echo "<div class='alert alert-danger'>Maaf periksa kembali NIDN dan Password anda</div>"; 
      ...
      { 
        echo "<div class='alert alert-danger'>Maaf anda belum Login.<br/>Silahkan Login dengan NIDN dan Password anda.</div>";
      } else { 
...
?>
        ...
        <form action="<?php echo base_url() ?>admin/kemahasiswaan/masuk_bea_dsn/proses" method="post">
          <div class="logo">
        ...
        <br>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="userName" class="form-control" name="username" placeholder="NIDN" required="required" autofocus="autofocus">
              <label for="useraName">NIDN</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
          ...
          <button type="submit" class="btn btn-info btn-block" >Login Dosen</button>
