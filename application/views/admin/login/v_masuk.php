...
<head>
  ...
  var txt=" Kemahasiswaan | Login Sistem Informasi Kemahasiswaan |";
...
?>
        ...
        <br>
          ...
          <div class="link">
            <h5 style="margin-bottom: -20px;"><a href="<?php echo base_url().'beranda'?>">Kembali ke Beranda</a></h5>
            <h5><a href="<?php echo base_url().'pengguna'?>">Masuk sebagai?</a></h5>
          </div>
