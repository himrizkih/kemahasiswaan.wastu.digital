...
<form action="<?php echo base_url() ?>admin/kemahasiswaan/masuk/proseseditpass" method="post">
    <div class="form-group">
      <div class="alert alert-warning">Alert! Password yang telah berhasil diubah akan langsung dialihkan ke halaman Login, untuk login dengan password yang baru</div>
