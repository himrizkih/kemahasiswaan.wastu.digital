...
<a style="margin-bottom: 10px;" href="<?php echo base_url() ?>admin/kemahasiswaan/beasiswa/penerima" class="btn btn-sm btn-primary float-left"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<table class="table table-striped" id="display">
    <tbody>
            ...
            <tr>
                <td width="200px" scope="row"><strong>Tanggal Persetujuan</strong></td>
                <td>:</td>
