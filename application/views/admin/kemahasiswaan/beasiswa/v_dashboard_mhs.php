...
<head>
  ...
  <title>Kemahasiswaan - Beasiswa - Profil</title>

  <!-- Slider Title -->
  <script language="JavaScript">
  var txt=" Kemahasiswaan - Beasiswa - Profil |";
  ...
  <?php $this->load->view('layout/v_script-nice-admin');?>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-12 text-center text-lg-start">
            <h2><a href="#"><span>|</span>Profil Mahasiswa</a></h2>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo base_url().'theme/assets/img/beasiswa/user.jpg'?>" alt="Profile" class="rounded-circle">
              <h2><?php echo $this->session->userdata('nama') ?></h2>
              <h3><?php if ($this->session->userdata('status')=='mhs') {
                echo 'Mahasiswa';}?></h3>
            </div>
          </div>
