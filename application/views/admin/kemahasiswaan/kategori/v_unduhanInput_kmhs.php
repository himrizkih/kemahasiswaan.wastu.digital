<div class="card mb-3">
 <div class="card-header">
  <i class="fas fa-table"></i> Tambah Unduhan
   ...
   <div class="card-body">
    <a href="<?php echo base_url() ?>admin/kemahasiswaan/kategori/unduhan_kmhs" class="btn btn-sm btn-primary float-left"><i class="fas fa-arrow-left"></i> Kembali</a>
    <br> 
    <p></p>
    
    <div class="table-responsive">
        <form action="<?php echo base_url() ?>admin/kemahasiswaan/kategori/unduhan_kmhs/add" method='post' enctype="multipart/form-data">
