          ...
          <div class="col-md-2">
            <div class="footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="#">Ormawa</a></li>
          ...
          <div class="col-md-2">
            <div class="footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="#">LLDIKTI Wilayah IV</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="footer-content">
              <div class="footer-head">
                <h4>Informasi</h4>
                <p>
                  Bidang Kemahasiswaan HUMAS dan HUBIN
