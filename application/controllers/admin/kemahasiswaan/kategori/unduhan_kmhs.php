 ...
 Class unduhan_kmhs extends CI_Controller {
    ...
    function index() {
        ...
        $this->session->userdata('departemen')=='Kemahasiswaan') {
            ...
            $this->load->view('admin/kemahasiswaan/kategori/v_unduhan_kmhs', $data);
    ...
    public function add()
    {
        if (isset($_POST['simpan'])) {
           ...
           if ($lampiran=''){}else{
            ...
            redirect('admin/kemahasiswaan/kategori/unduhan_kmhs?pesan=berhasil_input');
            
        }else{
            $this->load->view('admin/kemahasiswaan/v_header');
            $this->load->view('admin/kemahasiswaan/kategori/v_unduhanInput_kmhs');
            $this->load->view('admin/kemahasiswaan/v_footer');
        ...
        if (isset($_POST['update'])) {
           ...
           if ($lampiran=''){}else{
            ...
            // );
             ...
             redirect('admin/kemahasiswaan/kategori/unduhan_kmhs?pesan=berhasil_edit');
        }else{
    ...
    public function delete($id){
        ...
        redirect('admin/kemahasiswaan/kategori/unduhan_kmhs?pesan=berhasil_hapus');
    }
