 ...
 Class Pendaftar extends CI_Controller {
    ...
    function index() {
        ...
        if($this->session->userdata('status')=='kmhs') {
            ...
            $data['beasiswa']=$this->m_crud->edit_data_v2('beasiswa')->result();
    ...
    public function detail($id){
        ...
        $data['beasiswa']=$this->m_crud->edit_data_v2('beasiswa')->row_array();
        $this->load->view('admin/kemahasiswaan/beasiswa/v_header_dsn');
    ...
    public function proses(){
        ...
        // $data['beasiswa']=$this->m_crud->edit_data_v2('beasiswa')->row_array();
        $idb=$this->input->post('id_beasiswa');
        $beasiswa=$this->m_crud->edit_data(array('id_beasiswa'=>$idb),'beasiswa')->row_array();
        ...
        if (isset($_POST['disetujui'])) {
            if($this->session->userdata('status')=='kmhs') {
                ...
                // $this->m_crud->update_data(array('id_beasiswa'=>$idb),array('kuota_mhs'=>-=1),'beasiswa');
                // $this->m_crud->update_data(array('id_beasiswa'=>$idb),array('kuota_mhs'-=1),'beasiswa');
